...
menuItems.forEach((item, index) => {
  item.addEventListener("click", () => {
    ...
    choosenProduct.colors.forEach((colorObj, colorIndex) => {
      if (currentProductColors[colorIndex]) {
        currentProductColors[colorIndex].style.backgroundColor = colorObj.code;
      }
    });
  });
});
